...
@WebServlet(value = "/scheduling/regionchoicefrom.action")
public class RegionChoiceFromServlet extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		
		RequestDispatcher dispatcher =
 				req.getRequestDispatcher("/WEB-INF/views/scheduling/regionchoicefrom.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
		...
		resp.sendRedirect(String.format("/upgo/scheduling/regionchoiceto.action?departregion=%s",departregion )); //이건 확인필요
