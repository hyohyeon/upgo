              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form action="findpasswd.action" id="findform" role="form" autocomplete="off" class="form" method="post">
    
                      <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                          <input id="memberId" name="memberId" placeholder="ID" class="form-control"  type="text"
                          title="기억나는 아이디를 입력하세요.">
                        </div>
                        <br>
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                          <input id="email" name="email" placeholder="email address" class="form-control"  type="text"
                          title="기억나는 이메일을 입력하세요.">
                        </div>
                        
                      </div>
                      <div class="form-group">
                        <input name="findpasswd" class="btn btn-lg btn-primary btn-block" value="비밀번호 찾기" type="submit">
                      </div>
