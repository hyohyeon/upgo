	...
	<div id="pageContainer">
		...
		<div id="inputcontent">
		    <div id="inputmain">
		        ...
		        <form id="replyform" action="tworeply.action" method="post">
		        ...
		        <div class="buttons">
		        	...
		        	&nbsp;&nbsp;
		        	<a href='/upgo/twoboard/twodetail.action?boardno=<%= request.getAttribute("boardno")%>'>취소</a>
		        	&nbsp;&nbsp;
		        	<a href="/upgo/twoboard/twolist.action">목록보기</a>
		        </div>
		        </form>
		    </div>
		</div>   	
