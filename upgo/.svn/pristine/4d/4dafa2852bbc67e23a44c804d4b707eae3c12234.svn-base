...
public class RegisterFormServlet extends HttpServlet {
   ...
   out.println("   <link rel='Stylesheet' href='/upgo/styles/default.css' />");
   out.println("   <link rel='Stylesheet' href='/upgo/styles/input.css' />");
   out.println("</head>");
   out.println("<body>");
   ...
   out.println("               <a href='/upgo/account/loginform.action'>로그인</a>");
   out.println("                <a href='/upgo/account/registerform.action'>회원가입</a>");                            
   out.println("            </div>");
   out.println("        </div>");        
   ...
   out.println("                      <td>");
   out.println("                          <input type='text' id='C_ID' name='C_ID' style='width:280px' />");
   out.println("                      </td>");
   out.println("                  </tr>");
   out.println("                  <tr>");
   out.println("                      <th>비밀번호</th>");
   out.println("                      <td>");
   out.println("                         <input type='password' id='C_PASSWD' name='C_PASSWD' style='width:280px' />");
   out.println("                      </td>");
   out.println("               </tr>");
   out.println("                  <tr>");
   ...
   out.println("                      <td>");
   out.println("                         <input type='text' id='C_EMAIL' name='C_EMAIL' style='width:280px' />");
   out.println("                      </td>");
   out.println("                  </tr>");                               
   out.println("              </table>");
   out.println("              <div class='buttons'>");
   out.println("                 <input type='submit' value='등록' style='height:25px' />");
   out.println("                 <input type='button' value='취소' style='height:25px' onclick=\"location.href='/home.jsp/'\"/>");   
   out.println("              </div>");
   out.println("              </form>");
   out.println("          </div>");
   out.println("      </div>");
